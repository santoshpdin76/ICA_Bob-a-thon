...
- Name: 02-dashboard.spec.js >> Dashboard Functionality >> should display responsive layout on different screen sizes
- Location: e2e-tests/02-dashboard.spec.js:109:7
